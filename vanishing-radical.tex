...
The case for $J^3=0$ was first proved by Green--Zimmerman-Huisgen\cite[Theorem~16]{GZH91}. Here we give a simplified proof, due to Igusa--Todorov, using the $\psi$-function from \cref{sec:Igusa-Todorov}.
