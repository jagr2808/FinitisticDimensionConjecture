...
\begin{theorem}
	...
	\begin{proof}
		This was proven by Iyama in 2002. The proof is omitted here, but can be found in \cite{Iya02}.
	\end{proof}
\end{theorem}
