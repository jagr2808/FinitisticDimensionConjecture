...
\begin{prop}\label{prop:repdim_auslander_generator} \todo{I guess this is Auslanders original definition}
	...
	\begin{proof}
		...
		The Yoneda embedding gives an equivalence $$\Hom_\Gamma(-,I_0(\Gamma)):\add I_0(\Gamma) \to \proj\End_\Gamma(I_0(\Gamma))^{\operatorname{op}},$$ and thus we get an equivalence $$D\Hom_\Gamma(-,I_0(\Gamma)):\add I_0(\Gamma) \to \inj\End_\Gamma(I_0(\Gamma))$$
