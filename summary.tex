...
\begin{theorem}\label{thm:Findim_summary}
	...
	\begin{proof}
		\begin{enumerate}[(a)]
			...
			\item Any infinitely generated module is the direct limit of its finitely generated submodules. Since all finitely generated submodules has projective dimension less than the global dimension, it follows that also infinitely generated modules do\todo{why this follows? Tor commutes with direct limits}. So $\Findim(\Lambda) = \operatorname{gl.dim}(\Lambda)$.
