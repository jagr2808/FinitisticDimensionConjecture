...
\begin{theorem}
	...
	\begin{proof}
		\begin{enumerate}[(a)]
			...
			\item Over a Gorenstein algebra, a module has finite injective dimension if and only if it has finite projective dimension. By looking at sequences $X \to I \to I'$ and taking long exact sequences in Ext we get that $\Findim(\Lambda) = \pd D\Lambda$. \todo{Write details somewhere}
