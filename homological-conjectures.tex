...
The proofs above do not necessarily work on the level of individual algebras. For example for the proof that WTC implies GSC we need to assume that WTC holds for both $\Lambda$ and $\Lambda^{\op}$ to prove that $\Lambda$ satisfies GSC.
